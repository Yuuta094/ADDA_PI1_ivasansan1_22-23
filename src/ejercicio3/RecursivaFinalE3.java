...
public class RecursivaFinalE3 {
	...
	public static List<Punto2D> Ejercicio3_recFinal (String file1, String file2){
		...
		return Ejercicio3_recFinal(file1,file2, List2.empty(),it,it2);
	}
	public static List<Punto2D> Ejercicio3_recFinal (String file1, String file2, List<Punto2D> ac,Iterator<Punto2D> it, Iterator<Punto2D> it2){	
		...
		if (it.hasNext()) {
				...
				ac= Ejercicio3_recFinal(file1,file2, ac, it, it2);
		}
		if (it2.hasNext()) {
