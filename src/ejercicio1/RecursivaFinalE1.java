...
//				} else {
//					
//					map.put(key, List.of(ec2));
//				} 
//			}else {
//				map.put(ec2.length(),List2.of(ec2));
//				}
//			}
//			if (ec.a()%3==0) {
//				map = ejercicio1_RecFinal(varA, varB, varC, varD, varE, map, EnteroCadena.of(ec.a() + 2, ec.s() + ec.a().toString()));
//			} else {
//				map = ejercicio1_RecFinal(varA, varB, varC, varD, varE, map, EnteroCadena.of(ec.a() + 2, ec.s().substring(ec.a() % ec.s().length())));
//			}
//		
//		return map;
//	}
